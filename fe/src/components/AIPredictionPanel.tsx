      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            <span className="text-gray-600">Water Quality Index (WQI)</span>
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-gray-900">Contamination Risk</span>
          </div>
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <span className="text-gray-600 text-sm">Predicted WQI</span>
        ...
        <div className="bg-indigo-100 rounded-xl p-4 border border-indigo-200">
          <div className="flex items-center justify-between text-sm">
            <span className="text-indigo-700">Model: Random Forest</span>
